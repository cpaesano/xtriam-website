  ...
  return (
    <div>
      ...
      <Link
        ...
        className="text-brand-blue-600 hover:text-brand-blue-700 flex items-center gap-1 mb-6 text-sm"
      >
        <svg
          className="w-4 h-4"
          fill="none"
      ...
      <div className="mb-6">
        <span
          className={`inline-block px-3 py-1 rounded-full text-xs font-medium mb-3 ${categoryColors[tutorial.category]}`}
        >
        ...
        {tutorial.lastUpdated && (
          <p className="text-gray-500 text-sm mt-2">
            Last updated: {tutorial.lastUpdated}
          </p>
        )}
      </div>
      ...
      <div className="mt-6 bg-brand-blue-50 rounded-xl p-6 text-center">
        ...
        <p className="text-gray-600 text-sm mb-4">
          Our AI assistant can answer follow-up questions, or contact support
