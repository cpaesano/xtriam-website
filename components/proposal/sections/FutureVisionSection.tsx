...
const features = [
  ...
  { id: "drawing-integration", label: "Drawing phase integration", description: "Dealers upload shop drawings or elevation sketches — AI extracts dimensions and specs automatically, auto-populates the configurator for real-time pricing" },
